...
[Backups externos automatizados: preparação e decisão pendente](docs/HO-012-BACKUPS.md). restic nativo com destino R2 UE proposto; sem bucket/timer ativo ou envio externo nesta preparação. Cópia manual no PC continua complementar.
