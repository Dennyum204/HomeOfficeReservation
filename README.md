...
[Backups externos automatizados: configuração pendente](docs/HO-012-BACKUPS.md). R2 autorizado e bucket privado UE criado; agenda diária/sete diárias e seis mensais preparada, sem timer ativo ou envio externo verificado. Cópia manual no PC continua complementar.
