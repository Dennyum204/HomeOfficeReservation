...
[Backups externos: envio e restauro verificados](docs/HO-012-BACKUPS.md). R2 privado UE, timers diário/semanal ativos, retenção sete diárias/seis mensais. Disparos agendados e alertas externos ainda pendentes; recuperação independente com Bitwarden passou. Cópia no PC continua complementar.
