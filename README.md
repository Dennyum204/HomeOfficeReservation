...
[Backups externos automatizados: configuração pendente](docs/HO-012-BACKUPS.md). R2 autorizado e bucket privado UE criado; agenda mensal/seis cópias preparada, sem timer ativo ou envio externo verificado. Cópia manual no PC continua complementar.
