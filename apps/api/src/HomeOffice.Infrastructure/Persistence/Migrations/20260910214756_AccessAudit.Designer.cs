...
namespace HomeOffice.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260910214756_AccessAudit")]
            ...
            modelBuilder.Entity("HomeOffice.Domain.Access.AccessAudit", b =>
                {
                    ...
                    b.ToTable("AccessAudits", null, t =>
                        {
                            t.HasCheckConstraint("CK_AccessAudit_Source", "(\"Source\" = 'operator' AND \"ActorMemberId\" IS NULL) OR (\"Source\" = 'administrator' AND \"ActorMemberId\" IS NOT NULL)");
                        });
                });
