...
public static class PlanningEndpoints
{
    ...
    public static void MapPlanning(this WebApplication app)
    {
        ...
        g.MapGet("/requests", (Guid employeeId, HttpContext c, IPlanningService s, CancellationToken ct, int offset = 0, int limit = 25) => s.Requests(Actor(c), employeeId, offset, limit, ct)).WithName("ListPlanningRequests");
