...
Para o teste nativo, iniciar **uma API de teste** com `Auth__AccessTokenSeconds=3`, `Auth__RefreshTokenSeconds=8`, `Auth__RequestsPerMinute=300` e ambiente Development. Depois:
