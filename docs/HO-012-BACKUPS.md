...
Monitorização externa: [integração preparada e decisão pendente](HO-012-BACKUP-MONITORING.md). Healthchecks.io Hobbyist proposto, três checks/US$0, destinatário por indicar; sem conta ou alertas reais. Ensaios simulados não substituem validação externa.
