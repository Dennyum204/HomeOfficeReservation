...
Core Web/Android integrado. HO-012: Pi instalado e HTTPS Cloudflare publicado; percurso titular → chefe → calendário/notificações aceite pelo responsável no browser do telemóvel em 2026-09-13. Aceitação parcial, PR #37 draft. SMTP real, backups externos automatizados, monitorização, Android físico/distribuição e aceitação final pendentes. NAS/Hetzner históricos; iOS/Outlook adiados.
